...
import { Home, Search, Library, ShoppingBag, User, Users, Globe } from 'lucide-react';
  ...
  return (
    <nav className="fixed bottom-0 w-full bg-[#121212]/90 backdrop-blur-md border-t border-white/10 px-6 py-3 z-50">
      <ul className="flex justify-between items-center max-w-5xl mx-auto">
        ...
        <TabItem href="/friends" icon={<Users size={24} />} label={t(language, 'nav', 'friends') || 'Amigos'} isActive={pathname === '/friends'} />
