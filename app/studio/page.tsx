...
import { Trash2, Plus, Minus, X, Play } from 'lucide-react';
import { toast } from 'sonner';
import { t } from '@/lib/i18n';

export default function StudioPage() {
  const [activeTab, setActiveTab] = useState<'mazos' | 'coleccion'>('coleccion');
    ...
    <div className="flex flex-col gap-6 min-h-screen pb-24 relative">
      ...
      {selectedCard && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/90 backdrop-blur-sm overflow-y-auto" onClick={() => setSelectedCard(null)}>
          <div className="flex flex-col items-center gap-6 max-w-md w-full animate-in fade-in zoom-in duration-200 py-8" onClick={e => e.stopPropagation()}>
