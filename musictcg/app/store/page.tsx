              ...
              <div className="relative z-10 flex-1">
                ...
                <div className="flex flex-wrap gap-2 mt-auto">
                  <button 
                    ...
                    className="bg-white text-black font-bold py-3 px-8 rounded-2xl disabled:opacity-50 disabled:cursor-not-allowed hover:scale-105 active:scale-95 transition-all flex items-center gap-2 shadow-xl"
                  >
                  ...
                  <button 
                    ...
                    className="bg-black/40 backdrop-blur-sm text-white font-bold py-3 px-6 rounded-2xl border border-white/10 disabled:opacity-50 disabled:cursor-not-allowed hover:bg-white/10 transition-all"
                  >
      ...
      <AnimatePresence>
        {isOpening && openedCards.length > 0 && (
          <motion.div 
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="fixed inset-0 z-[100] flex flex-col items-center justify-center p-4 bg-black/98 backdrop-blur-xl overflow-y-auto"
          >
                  ...
                  <div className="flex flex-wrap justify-center gap-4 sm:gap-6 w-full max-w-6xl px-4 mb-12">
                    {openedCards.map((item, i) => {
                      ...
                      return (
                        ...
                        >
                          <div className={`relative w-40 sm:w-48 aspect-[2.5/3.5] preserve-3d transition-all duration-500 ${item.revealed ? '' : 'hover:scale-105'}`}>
                            {/* Card Back */}
                            <div className="absolute inset-0 bg-gradient-to-br from-[#242424] to-[#121212] rounded-xl border-2 border-white/10 flex flex-col items-center justify-center gap-4 backface-hidden rotate-y-180 shadow-2xl overflow-hidden">
                              <div className="absolute inset-0 bg-gradient-to-tr from-transparent via-white/5 to-transparent" />
                              <div className="w-16 h-16 rounded-full bg-white/5 flex items-center justify-center relative z-10">
